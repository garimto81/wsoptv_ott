# PRD-0012: WSOPTV Phase 1 - Vimeo 기반 NBA TV 스타일 MVP
...
| **Created** | 2026-02-03 |
| **Author** | Claude Code |
| **Parent** | PRD-0002 v10.0, STRAT-0009 v1.1 |
...
| 포함 | 제외 (Phase 2+) |
|------|----------------|
| Single View 라이브/VOD | Multi-view (4분할) |
| Timeshift/DVR | Player Cam |
| **날짜/선수 기반 브라우징** (NBA TV 스타일) | StatsView 오버레이 |
| 구독 결제 (Stripe) | Hand Search |
...
| 계층 | NBA TV | WSOPTV Phase 1 대응 |
|:----:|--------|---------------------|
| **① 상단** | Score Strip (실시간 경기 스코어) | Tournament Ticker (진행 중 대회/테이블) |
| **② 중앙** | Hero 영역 (하이라이트/라이브) | Featured Content (메인 이벤트) |
| **③ 하단** | 콘텐츠 그리드 (Stories, Trending) | VOD 컬렉션 (시리즈, 하이라이트) |
...
| **Multi-view** | 동시 다중 스트림 | ❌ |

### 3.2 Vimeo 제약사항 및 대응

| 제약사항 | 영향 | 대응 방안 |
|---------|------|----------|
| **Multi-view 미지원** | 4분할 동시 시청 불가 | "Streams" 버튼으로 테이블 전환 유도 |
...
| **MultiView** | 4분할 모드 | ❌ 미지원 | Phase 2+ |
| **Key Plays** | 주요 장면 점프 | ⚠️ Featured Hands | 시간 기반 챕터 (Vimeo Chapters) |
| **레이아웃 전환** | 1/2/4 분할 | ❌ 미지원 | Single View만 제공 |

### 4.3 Players List (선수 목록)
...
| **Full Replays** | ✅ | ✅ |
| **Timeshift/DVR** | ✅ | ✅ |
| **Multi-platform** | ✅ (5대) | ✅ (5대) |
| **Exclusive Content** | - | ✅ |
| **Early Access** | - | ✅ |

#### Features Comparison (Free vs Plus)
...
| 요소 | 설명 |
|------|------|
| **Primary CTA** | SUBSCRIBE NOW - $99.99/year |
...
| **3** | Q1 2027 | Table Multi-view (4분할) - 커스텀 플레이어 |
...
| 문서 | 설명 |
|------|------|
| [PRD-0002](PRD-0002-wsoptv-concept-paper.md) | WSOPTV Concept Paper v10.0 |
| [PRD-0002-executive-summary](PRD-0002-executive-summary.md) | 경영진 보고용 요약 |
| [STRAT-0009](../strategies/STRAT-0009-gg-ecosystem-strategy.md) | GG 생태계 비즈니스 전략 |
