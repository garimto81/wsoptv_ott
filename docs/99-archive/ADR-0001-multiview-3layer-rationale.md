...
| **작성일** | 2026-01-16 |
| **상태** | **Superseded** (4계층으로 변경됨 - PRD-0006-v4 참조) |
| **영향도** | High - Advanced Mode의 핵심 UX 설계 |
| **관련 PRD** | [PRD-0002](../prds/PRD-0002-wsoptv-concept-paper.md), [PRD-0006](../prds/PRD-0006-advanced-mode.md) |

---

## Executive Summary

> ⚠️ **Superseded**: 이 문서는 **3계층 구조**의 설계 근거를 기록한 역사적 문서입니다.
> 현재는 **4계층 구조**로 업데이트되었습니다. 최신 설계는 [PRD-0006-v4](../prds/PRD-0006-advanced-mode.md)를 참조하세요.
...
| 문서 | 위치 | 설명 |
|------|------|------|
| PRD-0002 | [PRD-0002-wsoptv-concept-paper.md](../prds/PRD-0002-wsoptv-concept-paper.md) | Concept Paper v10.0 |
