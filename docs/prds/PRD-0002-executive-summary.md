...
| Version | 6.2 | 기준 문서 | PRD-0002 v9.1 |
|---------|-----|----------|---------------|
...
### Multi-view/Player Cam의 생태계적 의미

| 기능 | 독립 OTT 관점 | GG 생태계 관점 |
|------|-------------|---------------|
| **Multi-view** | 제작 비용 대비 불명확 | **포커 관전 놀이터** - 관심 선수 발견 |
| **Player Cam** | 비효율적, 쓸모없음 | **아이돌 팬덤** - 선수 감정 연결, 충성도 |
| **Hand Search** | 단순 편의 기능 | **명장면 컬렉션** - SNS 공유, 바이럴 |
| **StatsView** | 부가 정보 | **학습/분석** - GG POKER 스킬 향상 욕구 |
...
| 모드 | 단계 | 설명 |
|:----:|:----:|------|
| **Single View** | MVP | 1개 테이블 전체 화면, Timeshift 지원 |
| **Multi-view** | Phase 2 | 최대 4개 테이블 동시 시청, 클릭으로 오디오 전환 |
| **Player Cam** | Phase 4 | 아이돌 직캠 방식, 특정 플레이어 클로즈업 |
...
*v6.2 - 섹션 7 기술 구현 로드맵 교체: Production vs WSOPTV Architecture 리포트 내용 반영 (2026-01-30)*
