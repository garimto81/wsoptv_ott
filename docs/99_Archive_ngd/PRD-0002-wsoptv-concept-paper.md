...
![Multi-view Step 1: Ticker 선택 및 Single Video](../images/PRD-0002/04-multiview-step1.png)
...
| 단계 | 사용자 액션 | 시스템 반응 |
|:----:|------------|------------|
| 1 | Tournament Ticker에서 테이블 클릭 | **즉시 Single Video 시청 시작** |
...
![Option A: NBA TV 방식 (Info Tabs)](../00_Poc/reference/20-nba-tv-info-tabs.png)
...
|--------------|:---:|:--:|:--:|:--:|------|
| 라이브 스트리밍 | ✅ | | | | |
| **Tournament Ticker / Multi-view** | ✅ | ✅ | | | MVP: Single Video, P2: Multi-view 레이아웃 |
| GGPass SSO | ✅ | | | | |
| 구독 모델 | ✅ | | | | |
| Featured Hands | | ✅ | | | |
| 핸드 태깅/검색 | | ✅ | | | |
