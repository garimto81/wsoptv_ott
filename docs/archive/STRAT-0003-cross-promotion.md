# STRAT-0003: 상호 보완 프로모션 전략 (Cross-Promotion Strategy)
...
| **Author** | Claude Code |
| **Related** | [PRD-0002 Concept Paper](../prds/PRD-0002-wsoptv-concept-paper.md) |
...
- [PRD-0002 WSOPTV Concept Paper](../prds/PRD-0002-wsoptv-concept-paper.md)
- ~~STRAT-0010 Legal Compliance~~ (Archived - 칩 자동 생성 국가별 규제 검토)
- ~~STRAT-0011 GGPass Integration~~ (Archived - GGPass/GGPoker API 스펙)
