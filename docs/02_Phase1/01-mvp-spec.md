...
| **Status** | ⭐ Active |
| **Target** | Q3 2026 론칭 |
| **Depends** | [01-vision](../99_Archive_ngd/phase0/01-vision.md), [02-business](../99_Archive_ngd/phase0/02-business.md) |
...
![Navigation Map v2](../00_Poc/mvp-screens/00-navigation-map-v2.png)
...
> **기본 레이아웃 와이어프레임**: [POC Layout Wireframe](../00_Poc/poc-layout-wireframe.png)
...
> **POC 와이어프레임 확정 (2026-02-06)**: `docs/00_Poc/poc-layout-wireframe.png`을 기본 레이아웃으로 채택. Vimeo 기술 팀 리뷰용 B&W 와이어프레임 기준.
...
*와이어프레임: [HTML 원본](../00_Poc/mvp-screens/archive_ngd/01-home-schedule-view.html) | [스크린샷](../00_Poc/mvp-screens/01-home-schedule-view.png)*
...
> **기본 레이아웃 참조**: POC 와이어프레임(`docs/00_Poc/poc-layout-wireframe.png`)이 기본 3계층 구조의 확정 버전입니다. 아래 ASCII 다이어그램은 해당 와이어프레임의 텍스트 표현입니다.
...
*와이어프레임: [HTML 원본](../00_Poc/mvp-screens/archive_ngd/02-players-list.html) | [스크린샷](../00_Poc/mvp-screens/02-players-list.png)*
...
*와이어프레임: [HTML 원본](../00_Poc/mvp-screens/archive_ngd/03-player-profile.html) | [스크린샷](../00_Poc/mvp-screens/03-player-profile.png)*
...
*와이어프레임: [HTML 원본](../00_Poc/mvp-screens/archive_ngd/04-event-detail.html) | [스크린샷](../00_Poc/mvp-screens/04-event-detail.png)*
...
![Navigation Map](../00_Poc/mvp-screens/00-navigation-map.png)

[HTML 원본](../00_Poc/mvp-screens/archive_ngd/00-navigation-map.html)
...
*와이어프레임: [HTML 원본](../00_Poc/mvp-screens/archive_ngd/05-watch-hub.html) | [스크린샷](../00_Poc/mvp-screens/05-watch-hub.png)*
...
*와이어프레임: [HTML 원본](../00_Poc/mvp-screens/archive_ngd/06-live-player.html) | [스크린샷](../00_Poc/mvp-screens/06-live-player.png)*
...
![VOD Player](../00_Poc/mvp-screens/07-vod-player.png)

[HTML 원본](../00_Poc/mvp-screens/archive_ngd/07-vod-player.html)
...
*와이어프레임: [HTML 원본](../00_Poc/mvp-screens/archive_ngd/08-highlights-hub.html) | [스크린샷](../00_Poc/mvp-screens/08-highlights-hub.png)*
...
*와이어프레임: [HTML 원본](../00_Poc/mvp-screens/archive_ngd/09-subscribe-modal.html) | [스크린샷](../00_Poc/mvp-screens/09-subscribe-modal.png)*

> **참고**: 스크린샷은 초기 목업 가격($14.99/$99.99)을 표시합니다. 최종 가격은 아래 테이블 기준입니다. (권위 소스: [02-business](../99_Archive_ngd/phase0/02-business.md) 섹션 7)
...
*와이어프레임: [HTML 원본](../00_Poc/mvp-screens/archive_ngd/10-sign-in.html) | [스크린샷](../00_Poc/mvp-screens/10-sign-in.png)*
...
| 문서 | 설명 |
|------|------|
| [PRD-0002](../99_Archive_ngd/PRD-0002-wsoptv-concept-paper.md) | WSOPTV Concept Paper (Archive) |
| [PRD-0002-executive-summary](../99_Archive_ngd/PRD-0002-executive-summary.md) | 경영진 보고용 요약 (Archive) |
| [02-business](../99_Archive_ngd/phase0/02-business.md) | GG 생태계 비즈니스 전략 |
| [05-competitor-ott-analysis](../01_Phase0/05-competitor-ott-analysis.md) | 경쟁 OTT 분석 (NBA TV, NFL, MLB, ESPN+) |
