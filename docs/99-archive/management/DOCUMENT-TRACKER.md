...
| rfp-feedback-request-templates | [archive/](../archive/rfp-feedback-request-templates.md) | RFP 피드백 요청 템플릿 | PRD-0005 기반, outdated |
| vendor-evaluation-matrix | [archive/](../archive/vendor-evaluation-matrix.md) | 업체 평가 매트릭스 | PRD-0005 기반, outdated |
| REPORT-2026-02-02-nfl-mlb | [archive/](../archive/REPORT-2026-02-02-nfl-mlb-ott-reference.md) | NFL/MLB OTT 레퍼런스 | 분석 미완료, 현 RFP 범위 밖 |

> 전체 archive 목록: [archive/README.md](../archive/README.md) (26개)
...
**의존성 규칙**: 01-vision 변경 시 하위 5개 문서 검토 필요
