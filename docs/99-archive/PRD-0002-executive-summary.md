...
| 모드 | 단계 | 설명 | 출처 |
|:----:|:----:|------|:----:|
| **Single Video** | MVP | 1개 테이블 전체 화면, Timeshift 지원 | 일반 OTT |
...
| **대응** | MVP는 Single Video로 시작, 추후 확장 검토 |
