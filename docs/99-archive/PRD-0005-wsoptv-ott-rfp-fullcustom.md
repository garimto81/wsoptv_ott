...
> **참고**: 본 RFP는 **단일 스트리밍 MVP** 버전입니다. Multi-video 기능은 Phase 2 이후 검토 대상이며, MVP 범위에서 제외됩니다.
>
...
> **참고**: Multi-video는 MVP 범위에서 제외됩니다. (Phase 2 이후 별도 검토)
...
> **참고**: Multi-video 기능은 MVP에서 제외. [REPORT-2026-01-21](../reports/REPORT-2026-01-21-multiview-production-issues.md)에서 프로덕션 워크플로우 이슈로 Phase 2 이후 검토 권장.
...
> **참조**: [PRD-0002](PRD-0002-wsoptv-concept-paper.md), [STRAT-0001](../strategies/STRAT-0001-viewer-experience-vision.md)

| 티어 | 가격 | 명칭 | 주요 기능 |
|------|------|------|----------|
| Basic | **$9.99/월** | **WSOP Plus** | 라이브, VOD, Timeshift, 자막 |
| Premium | **$49.99/월** | **WSOP Plus+** | Plus 기능 + StatsView (HUD 연동) |
...
| 항목 | 사유 |
|------|------|
| **Multi-video** | Phase 2 이후 검토 (프로덕션 워크플로우 변경 필요) |
...
> **참고**: Multi-video 제외 근거는 [REPORT-2026-01-21](../reports/REPORT-2026-01-21-multiview-production-issues.md) 참조
...
| 3.0 | 2026-02-04 | Claude Code | Selected View vs Multi-video 용어 명확화 |
| **2.0** | **2026-01-22** | **Claude Code** | **Single-Stream MVP로 전면 개정**: Multi-video 제외 (Phase 2), YouTube 대비 차별점 반영 (Timeshift, 아카이브), StatsView 추가, 콘텐츠 소싱 전략 반영, REPORT-2026-01-21 멀티뷰 이슈 검토 결과 반영 |
